...
const today = new Date("2026-05-05T00:00:00+09:00");
...
function analyzePortfolio(dataset, basis, label) {
  ...
  const scoreBreakdown = [
    ...
    { key: "sector-following", label: "후행 섹터 집중", level: sectorFollowingRisk, points: riskPoints(sectorFollowingRisk, 2, 1), max: 2, color: "#117a70" },
    { key: "concentration", label: "단일 자산 집중", level: singleAssetRisk, points: riskPoints(singleAssetRisk, 2, 1), max: 2, color: "#345e87" },
    { key: "sector-concentration", label: "섹터 편중", level: sectorConcentrationRisk, points: riskPoints(sectorConcentrationRisk, 2, 1), max: 2, color: "#7359a8" },
  ];
